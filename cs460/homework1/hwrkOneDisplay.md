...
#### I used a single column layout with an ordered list for my Git reference page. It is very long, so you can click on the link to take you to the page
...
1. # Sedond Requirement
### This part demonstrates the use of CSS code, it is my main css file for the website.
...
### I used three types of lists like ul, ol, and dl. I demonstrated the ol in the Git reference page and the ul in the navbar. The dl is in the landing page as well.
[Landing Page](https://goo.gl/CynbUB)
[Git Page](https://goo.gl/huAzXL)
